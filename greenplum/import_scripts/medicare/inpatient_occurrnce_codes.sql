...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_texas/*/*inpatient_occurrnce_codes.csv.gz#transform=add_parentname'
)
...
--insert into medicare_texas.inpatient_occurrnce_codes 
select * 
from ext_inpatient_occurrnce_codes
