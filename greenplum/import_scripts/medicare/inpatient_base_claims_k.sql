...
LOCATION ( 
'gpfdist://greenplum01:8081/uthealth/medicare_national/*/*inpatient_base_claims_k.csv.gz#transform=add_parentname_filename_comma'
)
...
create table uthealth/medicare_national.inpatient_base_claims_k
WITH (appendonly=true, orientation=column, compresstype=zlib)
as
--insert into uthealth/medicare_national.inpatient_base_claims_k 
select * 
from ext_inpatient_base_claims_k
...
alter table medicare_national.inpatient_base_claims_k add column LTCH_DSCHRG_PYMT_ADJSTMT_AMT varchar;
...
LTCH_DSCHRG_PYMT_ADJSTMT_AMT varchar
) 
LOCATION ( 
'gpfdist://greenplum01:8081/uthealth/medicare_national/*/INPATIENT_BASE_CLAIMS.CSV#transform=add_parentname_filename_comma'
)
FORMAT 'CSV' ( HEADER DELIMITER ',' );
