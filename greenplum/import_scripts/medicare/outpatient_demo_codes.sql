...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare/*/*outpatient_demo_codes.csv.gz#transform=add_parentname'
)
...
--drop table medicare.outpatient_demo_codes;
create table medicare.outpatient_demo_codes
WITH (appendonly=true, orientation=column, compresstype=zlib)
as

--insert into medicare.outpatient_demo_codes 
select * 
from ext_outpatient_demo_codes
