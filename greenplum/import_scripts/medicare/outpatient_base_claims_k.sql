...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_national/*/*outpatient_base_claims_k.csv.gz#transform=add_parentname'
)
...
create table medicare_national.outpatient_base_claims_k
WITH (appendonly=true, orientation=column, compresstype=zlib)
as

--insert into medicare_national.outpatient_base_claims_k 
select * 
from ext_outpatient_base_claims_k
...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_national/*/*outpatient_base_claims_k.csv.gz#transform=add_parentname_filename_comma'
)
FORMAT 'CSV' ( HEADER DELIMITER ',' );
