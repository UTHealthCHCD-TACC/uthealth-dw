...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare/*/*hospice_span_codes.csv.gz#transform=add_parentname'
)
...
create table medicare.hospice_span_codes
WITH (appendonly=true, orientation=column, compresstype=zlib)
as

--insert into medicare.hospice_span_codes 
select * 
from ext_hospice_span_codes
...
select count(*)
from medicare.hospice_span_codes;