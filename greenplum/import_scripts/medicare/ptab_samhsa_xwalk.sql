...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_national/*/*ptab_samhsa_xwalk.csv.gz#transform=add_parentname_filename_comma'
)
...
create table medicare_national.ptab_samhsa_xwalk
WITH (appendonly=true, orientation=column, compresstype=zlib)
as

--insert into medicare_national.ptab_samhsa_xwalk 
