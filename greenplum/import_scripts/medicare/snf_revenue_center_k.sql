...
LOCATION ( 
'gpfdist://greenplum01:8081/uthealth/medicare_national/*/SNF_REVENUE_CENTER.CSV#transform=add_parentname_filename_comma'
)
...
--alter table uthealth/medicare_national.snf_revenue_center_k add column REV_CNTR_RP_IND_CD varchar;
--alter table uthealth/medicare_national.snf_revenue_center_k add column RC_MODEL_REIMBRSMT_AMT varchar;
...
-- Scratch
select year, count(*)
from uthealth/medicare_national.snf_revenue_center_k
group by 1
order by 1;