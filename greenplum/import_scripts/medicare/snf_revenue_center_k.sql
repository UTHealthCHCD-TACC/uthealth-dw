...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_texas/*/*snf_revenue_center_k.csv.gz#transform=add_parentname_filename_comma'
)
...
alter table medicare_texas.snf_revenue_center_k add column REV_CNTR_RP_IND_CD varchar;
alter table medicare_texas.snf_revenue_center_k add column RC_MODEL_REIMBRSMT_AMT varchar;
...
insert into medicare_texas.snf_revenue_center_k (year, 
