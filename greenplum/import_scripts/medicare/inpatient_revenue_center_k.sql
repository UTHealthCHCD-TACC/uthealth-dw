...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_national/*/*inpatient_revenue_center_k.csv.gz#transform=add_parentname'
)
...
create table medicare_national.inpatient_revenue_center_k
WITH (appendonly=true, orientation=column, compresstype=zlib)
as
--insert into medicare_national.inpatient_revenue_center_k 
select * 
from ext_inpatient_revenue_center_k
...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_national/*/*inpatient_revenue_center_k.csv.gz#transform=add_parentname_filename_comma'
)
FORMAT 'CSV' ( HEADER DELIMITER ',' );
