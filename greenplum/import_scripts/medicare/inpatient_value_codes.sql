...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_texas/*/*inpatient_value_codes.csv.gz#transform=add_parentname_filename_comma'
)
...
create table medicare_texas.inpatient_value_codes
WITH (appendonly=true, orientation=column, compresstype=zlib)
as

insert into medicare_texas.inpatient_value_codes (year,
...
select count(*)
from medicare_texas.inpatient_value_codes;