...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_national/*/*snf_base_claims_k.csv.gz#transform=add_parentname'
)
...
as
--insert into medicare_national.snf_base_claims_k 
select * 
from ext_snf_base_claims_k
...
alter table medicare_national.snf_base_claims_k add column CLM_RSDL_PYMT_IND_CD varchar;
alter table medicare_national.snf_base_claims_k add column PRVDR_VLDTN_TYPE_CD varchar;
alter table medicare_national.snf_base_claims_k add column RR_BRD_EXCLSN_IND_SW varchar;
alter table medicare_national.snf_base_claims_k add column CLM_MODEL_REIMBRSMT_AMT varchar;
...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_national/*/*snf_base_claims_k.csv.gz#transform=add_parentname_filename_comma'
)
FORMAT 'CSV' ( HEADER DELIMITER ',' );
