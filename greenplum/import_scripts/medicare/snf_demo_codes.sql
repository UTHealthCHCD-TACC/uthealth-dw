...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare/*/*snf_demo_codes.csv.gz#transform=add_parentname'
)
...
create table medicare.snf_demo_codes
WITH (appendonly=true, orientation=column, compresstype=zlib)
as

--insert into medicare.snf_demo_codes 
select * 
from ext_snf_demo_codes
