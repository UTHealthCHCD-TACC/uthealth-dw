...
LOCATION ( 
'gpfdist://greenplum01:8081/uthealth/uthealth/medicare_national/*/SNF_VALUE_CODES.CSV#transform=add_parentname_filename_comma'
)
...
create table uthealth/medicare_national.snf_value_codes
WITH (appendonly=true, orientation=column, compresstype=zlib)
as

insert into uthealth/medicare_national.snf_value_codes (year,
...
select count(*)
from uthealth/medicare_national.snf_value_codes;