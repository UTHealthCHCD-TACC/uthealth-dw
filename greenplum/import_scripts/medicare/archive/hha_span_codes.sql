...
LOCATION ( 
'gpfdist://greenplum01:8081/uthealth/medicare_national/*/*hha_span_codes.csv.gz#transform=add_parentname_filename_comma'
)
...
create table uthealth/medicare_national.hha_span_codes
WITH (appendonly=true, orientation=column, compresstype=zlib)
as

insert into uthealth/medicare_national.hha_span_codes (year,
...
select count(*)
from uthealth/medicare_national.hha_span_codes;
