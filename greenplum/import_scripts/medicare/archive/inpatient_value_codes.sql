...
LOCATION ( 
'gpfdist://greenplum01:8081/uthealth/medicare_national/*/*inpatient_value_codes.csv.gz#transform=add_parentname_filename_comma'
)
...
create table uthealth/medicare_national.inpatient_value_codes
WITH (appendonly=true, orientation=column, compresstype=zlib)
as

insert into uthealth/medicare_national.inpatient_value_codes (year,
...
select count(*)
from uthealth/medicare_national.inpatient_value_codes;