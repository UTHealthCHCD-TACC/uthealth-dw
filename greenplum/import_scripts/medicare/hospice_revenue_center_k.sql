...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_texas/*/*hospice_revenue_center_k.csv.gz#transform=add_parentname_filename_comma'
)
...
alter table medicare_texas.hospice_revenue_center_k add column REV_CNTR_RP_IND_CD varchar;
alter table medicare_texas.hospice_revenue_center_k add column RC_MODEL_REIMBRSMT_AMT varchar;
...
insert into medicare_texas.hospice_revenue_center_k (year,
BENE_ID,CLM_ID,CLM_THRU_DT,CLM_LINE_NUM,NCH_CLM_TYPE_CD,REV_CNTR,
REV_CNTR_DT,HCPCS_CD,HCPCS_1ST_MDFR_CD,HCPCS_2ND_MDFR_CD,HCPCS_3RD_MDFR_CD,
REV_CNTR_UNIT_CNT,REV_CNTR_RATE_AMT,REV_CNTR_PRVDR_PMT_AMT,REV_CNTR_BENE_PMT_AMT,
REV_CNTR_PMT_AMT_AMT,REV_CNTR_TOT_CHRG_AMT,REV_CNTR_NCVRD_CHRG_AMT,REV_CNTR_DDCTBL_COINSRNC_CD,
