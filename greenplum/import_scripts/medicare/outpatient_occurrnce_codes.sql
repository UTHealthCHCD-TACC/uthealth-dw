...
LOCATION ( 
'gpfdist://192.168.58.179:8081/medicare_national/*/*outpatient_occurrnce_codes.csv.gz#transform=add_parentname'
)
...
create table medicare_national.outpatient_occurrnce_codes
WITH (appendonly=true, orientation=column, compresstype=zlib)
as

--insert into medicare_national.outpatient_occurrnce_codes 
select * 
from ext_outpatient_occurrnce_codes
...
select count(*)
from medicare_national.outpatient_occurrnce_codes;