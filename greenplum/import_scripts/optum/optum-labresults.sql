...
create table optum_dod_refresh.lab_result2 (
...
LOCATION ( 
'gpfdist://192.168.58.179:8081/*_lr2*'
)
...
*/
-- Insert
insert into optum_dod_refresh.lab_result2
select * from optum_dod_refresh.lab_result;
