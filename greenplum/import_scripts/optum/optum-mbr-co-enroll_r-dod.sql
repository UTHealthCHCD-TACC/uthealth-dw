/* ******************************************************************************************************
 *  This script loads optum_dod.mbr_co_enroll_r table, DOD only
...
LOCATION ( 
'gpfdist://greenplum01.corral.tacc.utexas.edu:8081/uthealth/optum_dod/dod_mbr_co_enroll_r.txt.gz'
)
...
create table optum_dod.mbr_co_enroll_r_new
WITH (appendonly=true, orientation=column, compresstype=zlib)
as 
select PATID, ELIGEFF, ELIGEND, GDR_CD, RACE, YRDOB, EXTRACT_YM, version, patid::text as member_id_src
...
drop table optum_dod.mbr_co_enroll_r
ALTER TABLE optum_dod.mbr_co_enroll_r_new RENAME TO mbr_co_enroll_r;
