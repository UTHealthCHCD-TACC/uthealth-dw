/* ******************************************************************************************************
 *  This script loads optum_dod/zip.mbrwdeath table.  dod only
...
LOCATION ( 
'gpfdist://greenplum01.corral.tacc.utexas.edu:8081/uthealth/optum_dod/dod_mbrwdeath.txt.gz'
)
...
create table optum_dod.mbrwdeath_new
WITH (appendonly=true, orientation=column, compresstype=zlib)
as 
...
drop table optum_dod.mbrwdeath;
ALTER TABLE optum_dod.mbrwdeath_new RENAME TO mbrwdeath;
