...
LOCATION ( 
'gpfdist://greenplum01.corral.tacc.utexas.edu:8081/uthealth/optum_dod/*\/dod_r2*.txt.gz#transform=add_parentname_filename_vertbar'
)
...
select file, count(*)
from optum_dod.rx
where file > 'dod_r2020q1.txt.gz'
group by 1;

delete
from optum_dod.rx
where file >= 'dod_r2020q3.txt.gz';
