--Medical
drop table opt_20210107.proc;
create table opt_20210107.proc (
...
BETOS_CODE varchar,BETOS_DESC varchar,SOURCEID varchar) 
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210107/*proc.txt.gz'
)
...
insert into opt_20210107.proc
select * from ext_covid_proc;

--Scratch
select count(*)
from opt_20210107.proc
group by 1
order by 1;