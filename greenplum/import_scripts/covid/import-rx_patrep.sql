--Medical
drop table opt_20210916.rx_patrep;
create table opt_20210916.rx_patrep (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210916/*rx_patrep*.txt.gz'
)
...
insert into opt_20210916.rx_patrep
select * from ext_covid_rx_patrep;

--Scratch
select count(*)
from opt_20210916.rx_patrep
group by 1
order by 1;