--Medical
drop table opt_20210401.obs;
create table opt_20210401.obs (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210401/*obs*.txt.gz'
)
...
insert into opt_20210401.obs
select * from ext_covid_obs;

--Scratch
select count(*)
from opt_20210401.obs
group by 1
order by 1;