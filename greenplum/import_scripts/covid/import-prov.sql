--Medical
drop table opt_20210624.prov;
create table opt_20210624.prov (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210624/*prov*.txt.gz'
)
...
insert into opt_20210624.prov
select * from ext_covid_prov;

--Scratch
select count(*)
from opt_20210624.prov
group by 1
order by 1;