--Medical
drop table opt_20210401.ins;
create table opt_20210401.ins (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210401/*ins*.txt.gz'
)
...
insert into opt_20210401.ins
select * from ext_covid_ins;

--Scratch
select count(*)
from opt_20210401.ins
group by 1
order by 1;