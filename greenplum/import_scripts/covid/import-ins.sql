--Medical
drop table opt_20210916.ins;
create table opt_20210916.ins (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210916/*ins*.txt.gz'
)
...
insert into opt_20210916.ins
select * from ext_covid_ins;

--Scratch
select count(*)
from opt_20210916.ins
group by 1
order by 1;