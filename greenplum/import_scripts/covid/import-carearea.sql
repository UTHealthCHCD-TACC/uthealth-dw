...
--Medical
drop table opt_20210401.carearea;
create table opt_20210401.carearea (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210401/*carearea*.*'
)
...
insert into opt_20210401.carearea
select * from ext_covid_carearea;

--Scratch
select count(*)
from opt_20210401.carearea
group by 1
order by 1;