--Medical
drop table opt_20210916.rx_adm;
create table opt_20210916.rx_adm (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210916/*rx_adm*.txt.gz'
)
...
insert into opt_20210916.rx_adm
select * from ext_covid_rx_adm;

--Scratch
select count(*)
from opt_20210916.rx_adm
group by 1
order by 1;