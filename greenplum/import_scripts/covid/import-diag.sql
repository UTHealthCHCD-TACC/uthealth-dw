--Medical
drop table opt_20210916.diag;
create table opt_20210916.diag (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210916/*diag*.txt.gz'
)
...
limit 1000;
*/
-- Insert: 3m20s, Updated Rows	352,349,506, Updated Rows	1,538,390,423
insert into opt_20210916.diag
select * from ext_covid_diag;

analyze opt_20210916.diag;

select count(*) from opt_20210916.diag;

--Scratch
select DIAGNOSIS_CD_TYPE, count(*), min(DIAG_DATE), max(DIAG_DATE), count(distinct ptid) as ptid_cnt
from opt_20210916.diag
group by 1;
