...
/*
 * Requires cleaning
 * tr -cd '\11\12\15\40-\176' < cov_20210107_lab.txt > cov_20210107_lab-fixed.txt
 */
--Medical
drop table opt_20210107.lab;
create table opt_20210107.lab (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210107/*lab-fixed.txt'
)
...
insert into opt_20210107.lab
select * from ext_covid_lab;

--Scratch
select l.test_name, count(*)
from opt_20210107.lab l
join opt_20210107.pt on l.ptid=pt.ptid
