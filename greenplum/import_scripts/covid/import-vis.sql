--Medical
drop table opt_20210107.vis;
create table opt_20210107.vis (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210107/*vis.txt.gz'
)
...
insert into opt_20210107.vis
select * from ext_covid_vis;

--Scratch
select count(*)
from opt_20210107.vis
group by 1
order by 1;