--Medical
drop table covid_20200525.vis;
create table covid_20200525.vis (
...
LOCATION ( 
'gpfdist://192.168.58.179:8081/covid/*vis.txt'
)
...
insert into covid_20200525.vis
select * from ext_covid_vis;

--Scratch
select count(*)
from covid_20200525.vis
group by 1
order by 1;