--Medical
drop table opt_20210128.vis;
create table opt_20210128.vis (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210128/*vis*.txt.gz'
)
...
insert into opt_20210128.vis
select * from ext_covid_vis;

--Scratch
select count(*)
from opt_20210128.vis
group by 1
order by 1;