/*
 * PTID|BIRTH_YR|GENDER|RACE|ETHNICITY|REGION|DIVISION|DECEASED_INDICATOR|DATE_OF_DEATH|
 * PROVID_PCP|IDN_INDICATOR|FIRST_MONTH_ACTIVE|LAST_MONTH_ACTIVE|NOTES_ELIGIBLE|HAS_NOTES|
