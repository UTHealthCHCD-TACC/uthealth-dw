--Medical
drop table opt_20210916.rx_immun;
create table opt_20210916.rx_immun (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210916/*rx_immun*.txt.gz'
)
...
insert into opt_20210916.rx_immun
select * from ext_covid_rx_immun;

--Scratch
select count(*)
from opt_20210916.rx_immun
group by 1
order by 1;