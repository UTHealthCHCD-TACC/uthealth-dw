--Medical
drop table opt_20210128.rx_presc;
create table opt_20210128.rx_presc (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210128/*rx_presc*.txt.gz'
)
...
insert into opt_20210128.rx_presc
select * from ext_covid_rx_presc;

--Scratch
select count(*)
from opt_20210128.rx_presc
group by 1
order by 1;