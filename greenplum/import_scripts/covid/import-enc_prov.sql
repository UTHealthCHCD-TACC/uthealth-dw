--Medical
drop table opt_20210128.enc_prov;
create table opt_20210128.enc_prov (
...
LOCATION ( 
'gpfdist://greenplum01:8081/covid/20210128/*enc_prov*.txt.gz'
)
...
insert into opt_20210128.enc_prov
select * from ext_covid_enc_prov;

--Scratch
select sourceid, count(*)
from opt_20210128.enc_prov
group by 1
order by 1;