...
drop table dev.wc_ape_65plus_2017;
...
where a.procedure_cd in ('99381','99382','99383','99384','99385','99386','99387',
						 ...
						 'S0610','S0612','S0615')
      and a.year = 2017 
      and a.uth_member_id in ( select uth_member_id from dev.wc_ape_65plus_2017)
;


insert into dev.wc_ape_65plus_2017_vacc
select distinct uth_member_id 
from data_warehouse.claim_diag 
where diag_cd in ('Z0000','Z0001','Z00110','Z00111','Z00121','Z00129','Z003','Z01411','Z01419',
				  'V700','V700','V7231','V705','V703','V7284','V7285') 
      and year = 2017 
      and uth_member_id in ( select uth_member_id from dev.wc_ape_65plus_2017)
      and uth_member_id not in ( select uth_member_id from dev.wc_ape_65plus_2017_vacc)
;


alter table dev.wc_ape_65plus_2017 add column vacc_flag int2 default 0;


update dev.wc_ape_65plus_2017 a set vacc_flag = 1
  from dev.wc_ape_65plus_2017_vacc b 
    where b.uth_member_id = a.uth_member_id
 ;

---combine medicaid and other data sets
drop table dev.wc_ape_65plus_all_2017


select * 
into dev.wc_ape_65plus_all_2017
from ( 
select * from dev.wc_ape_65plus_2017
union 
select client_num::bigint, sex, zip3, 'mdcd' as data_source,  vacc_flag::int from dev.wc_temp_mdcd65_ape_2017
) inr 
...
---all
	r_num := 0;
	r_den := (	select count(*) from dev.wc_ape_65plus_all_2017 );
...
---female 
	r_num := 0;
	r_den := (	select count(*) from dev.wc_ape_65plus_all_2017 where gender_cd = 'F' );
...
---male 
	r_num := 0;
	r_den := (	select count(*) from dev.wc_ape_65plus_all_2017 where gender_cd = 'M' );
...
select distinct gender_cd ,count(*), data_source from dev.wc_ape_65plus_all_2017 group by gender_cd, data_source;
...
---optum
--missing zip 753 772 
insert into dev.wc_ape_65plus_all_2017 values 
(0001,'M',753,'optz',0),
(0006,'F',753,'optz',0),
(0007,'M',772,'optz',0),
(0012,'F',772,'optz',0)
