...
create table dev.wc_temp_mdcd65_ape_2015 ( client_num text, fst_elig text, lst_elig text, zip3 char(3), sex char(1), age text, age_group text, vacc_flag text);


update dev.wc_temp_mdcd65_ape_2015 set vacc_flag = '0' where vacc_flag = '';

select count(*), sum(vacc_flag::int ) from dev.wc_temp_mdcd65_ape_2015
...
---medicare advantage
insert  into dev.wc_ape_65plus_2015
select uth_member_id, 
       a.gender_cd, 
       a.zip3,
...
---
drop table dev.wc_ape_65plus_2015_vacc;
...
insert into dev.wc_ape_65plus_all_2015 values ('1','M','750','optz','0'),
('2','M','751','optz','0'),
('3','M','752','optz','0'),
('4','M','753','optz','0'),
('5','M','754','optz','0'),
