--influenza medicare advantage 2018

---optum and truven cohorts from DW
drop table dev.wc_flu_mcradv_2018;
...
---get vaccinations
drop table dev.wc_flu_mcradv_2018_vacc

select distinct uth_member_id 
into dev.wc_flu_mcradv_2018_vacc
...
where a.cpt_hcpcs in ('90630','90654','90655','90655','90656','90657','90658','90658','90660','90661','90662',
      ...
      and a.year = 2018 
      and a.uth_member_id in ( select uth_member_id from dev.wc_flu_mcradv_2018)
;


alter table dev.wc_flu_mcradv_2018 add column vacc_flag int2 default 0;


update dev.wc_flu_mcradv_2018 a set vacc_flag = 1
  from dev.wc_flu_mcradv_2018_vacc b 
    where b.uth_member_id = a.uth_member_id
 ;

select count(*), sum(vacc_flag), data_source, count(distinct uth_member_id) as mem
from dev.wc_flu_mcradv_2018 
...
----------------------------------------------------------------------------------------
 ...
 insert into dev.wc_flu_mcradv_2018 values 
(0001, 753,1,'M','optz',0),
(0002, 753,2,'M','optz',0),
(0003, 753,3,'M','optz',0),
(0004, 753,4,'F','optz',0),
