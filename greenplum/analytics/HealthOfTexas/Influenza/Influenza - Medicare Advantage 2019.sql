--influenza medicare advantage 2019

---optum and truven cohorts from DW
drop table dev.wc_flu_mcradv_2019;
...
---get vaccinations
drop table if exists dev.wc_flu_2019_vacc;

select distinct uth_member_id 
into dev.wc_flu_2019_vacc
from data_warehouse.claim_detail a
where a.cpt_hcpcs_cd in ('90630','90654','90655','90655','90656','90657','90658','90658','90660','90661','90662',
...
alter table dev.wc_flu_mcradv_2019 add column vacc_flag int2 default 0;


update dev.wc_flu_mcradv_2019 a set vacc_flag = 1
...
----------------------------------------------------------------------------------------
 ...
 insert into dev.wc_flu_mcradv_2019 values 
(0001, 753,1,'M','optz',0),
(0002, 753,2,'M','optz',0),
(0003, 753,3,'M','optz',0),
(0004, 753,4,'F','optz',0),
