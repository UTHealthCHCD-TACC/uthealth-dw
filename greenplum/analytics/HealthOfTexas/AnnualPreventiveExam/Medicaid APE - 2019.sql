/****** Medicaid Annual Prev Exam 2020 ******/

drop table dev.wc_mdcd_ape_2020;
...
where enrl_months = 12 
 ...
 from dev.wc_mdcd_ape_2020	

 
delete from dev.wc_mdcd_ape_2020 where age_group is null;

delete from dev.wc_mdcd_ape_2020 where zip3 = '771';

delete from dev.wc_mdcd_ape_2020 where sex = 'U';

select count(*), age_group from dev.wc_mdcd_ape_2020  group by age_group order by age_group;


---------------------------------------------------------------------------------------------------------
----proc and hcpc
---------------------------------------------------------------------------------------------------------
drop table dev.wc_mdcd_ape_clm_2020 ;

select uth_member_id
  into dev.wc_mdcd_ape_clm_2020
...
----Diagnosis Codes
---------------------------------------------------------------------------------------------------------
insert into dev.wc_mdcd_ape_clm_2020
select uth_member_id 
...
----consolidate
--------------------------------------------------------------------------------------------------------
drop table dev.wc_mdcd_ape_mem_2020;

select distinct uth_member_id
into dev.wc_mdcd_ape_mem_2020
from dev.wc_mdcd_ape_clm_2020
;

-------------------------------------------------

alter table dev.wc_mdcd_ape_2020 add vacc_flag int default 0;


update dev.wc_mdcd_ape_2020 a set vacc_flag = 1
  from dev.wc_mdcd_ape_mem_2020 b 
