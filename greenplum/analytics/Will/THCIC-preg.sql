...
from THCIC_NEW.dbo.PUDF_charges_2010 pc 
where RECORD_ID in ( select record_id from stage.dbo.WC_THCIC_PREG_IP_BASE1 )

----main file
insert into stage.dbo.WC_THCIC_PREG_IP_BASE1
select RECORD_ID, SEX_CODE, PAT_AGE, PAT_ZIP, a.COUNTY, RACE, ETHNICITY ,FIRST_PAYMENT_SRC, PROVIDER_NAME,
...
from THCIC_NEW.dbo.PUDF_base1_2009 a
where a.SEX_CODE in ('F','U')
  and (    a.APR_DRG in ('370','371','372','373','374','375') 
