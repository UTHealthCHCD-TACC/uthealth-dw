...
insert into WRK.dbo.wc_TRS_obese_cohort
select distinct combo_ID, fscyr
from (
  select combo_id, med_FSCYR as fscyr 
		from trsers.dbo.TRS_BCBS_FIN_NEW a
		where a.MED_FSCYR between 2016 and 2021
	       and (   REPLACE(a.diagnosis_code_1 ,'.','') in ('E660','E661','E662','E668','E669','27800','27801','V853','V8530','V8531','V8532','V8533','V8534','V8535','V8536','V8537','V8538','V8539','V854' )
	       or REPLACE(a.diagnosis_code_2,'.','') in ('E660','E661','E662','E668','E669','27800','27801','V853','V8530','V8531','V8532','V8533','V8534','V8535','V8536','V8537','V8538','V8539','V854' )
	       or REPLACE(a.diagnosis_code_3,'.','') in ('E660','E661','E662','E668','E669','27800','27801','V853','V8530','V8531','V8532','V8533','V8534','V8535','V8536','V8537','V8538','V8539','V854' )
	       or REPLACE(a.diagnosis_code_4,'.','') in ('E660','E661','E662','E668','E669','27800','27801','V853','V8530','V8531','V8532','V8533','V8534','V8535','V8536','V8537','V8538','V8539','V854' )
	       or REPLACE(a.diagnosis_code_5,'.','') in ('E660','E661','E662','E668','E669','27800','27801','V853','V8530','V8531','V8532','V8533','V8534','V8535','V8536','V8537','V8538','V8539','V854' )
	      or REPLACE(a.diagnosis_code_1,'.','') like 'Z683%' or REPLACE(a.diagnosis_code_1,'.','') like 'Z684%'    
	       or REPLACE(a.diagnosis_code_2,'.','') like 'Z683%' or REPLACE(a.diagnosis_code_2,'.','') like 'Z684%' 
	       or REPLACE(a.diagnosis_code_3,'.','') like 'Z683%' or REPLACE(a.diagnosis_code_3,'.','') like 'Z684%' 
	       or REPLACE(a.diagnosis_code_4,'.','') like 'Z683%' or REPLACE(a.diagnosis_code_4,'.','') like 'Z684%' 
	       or REPLACE(a.diagnosis_code_5,'.','') like 'Z683%' or REPLACE(a.diagnosis_code_5,'.','') like 'Z684%' 		
	       )    	       
) inrx;
...
insert into WRK.dbo.wc_TRS_obese_counselling
select distinct combo_ID, fscyr
from (
  select combo_id, med_FSCYR as fscyr 
		from trsers.dbo.TRS_BCBS_FIN_NEW a
		where a.MED_FSCYR between 2016 and 2021		
	       and 
	       (   REPLACE(a.diagnosis_code_1,'.','') in ('Z713','Z7189','V653')
	       or REPLACE(a.diagnosis_code_2,'.','') in ('Z713','Z7189','V653')
	       or REPLACE(a.diagnosis_code_3,'.','') in ('Z713','Z7189','V653')
	       or REPLACE(a.diagnosis_code_4,'.','') in ('Z713','Z7189','V653')
	       or REPLACE(a.diagnosis_code_5,'.','') in ('Z713','Z7189','V653')
	       or a.drg in ('619','620','621')
	       or a.icd_procedure_code_1  in ('4389','443','4431','4438','4439','4468','4495','4496','4497','4499','445','4551','4521',
                          '0DV60CZ','0DV60DZ','0DV63CZ','0DV63DZ','0DV64CZ','0DV64DZ','0DV67DZ','0DV68DZ')
	       or a.icd_procedure_code_2 in ('4389','443','4431','4438','4439','4468','4495','4496','4497','4499','445','4551','4521',
                          '0DV60CZ','0DV60DZ','0DV63CZ','0DV63DZ','0DV64CZ','0DV64DZ','0DV67DZ','0DV68DZ')
	       or a.icd_procedure_code_3  in ('4389','443','4431','4438','4439','4468','4495','4496','4497','4499','445','4551','4521',
                          '0DV60CZ','0DV60DZ','0DV63CZ','0DV63DZ','0DV64CZ','0DV64DZ','0DV67DZ','0DV68DZ')
           )	              
) inrx;
