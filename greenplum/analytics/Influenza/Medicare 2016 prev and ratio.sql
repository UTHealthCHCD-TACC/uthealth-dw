...
drop table dev.wc_flu_mdcr_2016;
...
select count(*), year  from data_warehouse.claim_detail cd where data_source = 'mdcr'
group by year 


drop table dev.wc_flu_mdcr_2016_vacc;

select distinct uth_member_id 
into dev.wc_flu_mdcr_2016_vacc
...
where a.procedure_cd in ('90630','90654','90655','90655','90656','90657','90658','90658','90660','90661','90662',
      ...
      and a.year = 2016 
      and a.uth_member_id in ( select uth_member_id from dev.wc_flu_mdcr_2016)
;


alter table dev.wc_flu_mdcr_2016 add column vacc_flag int2 default 0;


update dev.wc_flu_mdcr_2016 a set vacc_flag = 1
  from dev.wc_flu_mdcr_2016_vacc b 
    where b.uth_member_id = a.uth_member_id
 ;

select count(*), sum(vacc_flag), data_source, count(distinct uth_member_id) as mem
from dev.wc_flu_mdcr_2016 
