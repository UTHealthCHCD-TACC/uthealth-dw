...
---all
	r_num := 0;
	r_den := (	select count(*) from dev.wc_flu_mcradv_2017  );
...
---female 
	r_num := 0;
	r_den := (	select count(*) from dev.wc_flu_mcradv_2017  where gender_cd = 'F' );
...
---male 
	r_num := 0;
	r_den := (	select count(*) from dev.wc_flu_mcradv_2017  where gender_cd = 'M' );
...
;
 ...
 select * from dev.wc_flu_mcradv_2017
