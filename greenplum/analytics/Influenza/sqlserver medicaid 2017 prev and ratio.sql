...
into stage.dbo.wc_mdcd_flu_2017_temp
from 
(
select client_nbr
...
into  stage.dbo.wc_mdcd_flu_clm_2017
from ( 
  select derv_enc 
...
drop table stage.dbo.wc_mdcd_flu_mem_2017;

select distinct mem_id 
into stage.dbo.wc_mdcd_flu_mem_2017
from 
(
	select distinct a.mem_id 
	from medicaid.dbo.enc_proc_17 a 
	where a.DERV_ENC in ( select derv_enc from stage.dbo.wc_mdcd_flu_clm_2017) 
union 
	select distinct a.mem_id 
...
union 
	...
	where a.ICN in (select derv_enc from stage.dbo.wc_mdcd_flu_clm_2017) 
union 
	select a.PCN
...
--apply flag
alter table stage.dbo.wc_mdcd_flu_2017 add vacc_flag int default 0;


update stage.dbo.wc_mdcd_flu_2017 set vacc_flag = 1
  from stage.dbo.wc_mdcd_flu_mem_2017 b 
...
drop table stage.dbo.wc_mdcd_flu_agg_2017 ;

select * 
into stage.dbo.wc_mdcd_flu_agg_2017
from stage.dbo.wc_mdcd_flu_2017
where age_group = 7;

delete from stage.dbo.wc_mdcd_flu_2017 where age_group = 7;
