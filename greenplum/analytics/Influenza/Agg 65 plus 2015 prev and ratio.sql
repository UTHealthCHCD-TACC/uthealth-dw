...
drop table dev.wc_temp_mdcd65_2015

create table dev.wc_temp_mdcd65_2015 ( client_num text, sex char(1), age text, zip3 char(3), vacc_flag text);


select count(*) , sum (vacc_flag::int) from dev.wc_temp_mdcd65_2015
...
update dev.wc_temp_mdcd65_2015 set vacc_flag = '0' where vacc_flag = '';
...
select * from dev.wc_flu_65plus_2015
union 
select client_num::bigint, sex, zip3, 'mdcd' as data_source,  vacc_flag::int from dev.wc_temp_mdcd65_2015
) inr 
