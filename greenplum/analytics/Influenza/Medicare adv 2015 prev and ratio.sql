--influenza medicare advantage 2015

---optum and truven cohorts from DW
drop table dev.wc_flu_mcradv_2015;
...
---get vaccinations
drop table dev.wc_flu_mcradv_2015_vacc

select distinct uth_member_id 
into dev.wc_flu_mcradv_2015_vacc
...
where a.procedure_cd in ('90630','90654','90655','90655','90656','90657','90658','90658','90660','90661','90662',
      ...
      and a.year = 2015 
      and a.uth_member_id in ( select uth_member_id from dev.wc_flu_mcradv_2015)
;


alter table dev.wc_flu_mcradv_2015 add column vacc_flag int2 default 0;


update dev.wc_flu_mcradv_2015 a set vacc_flag = 1
  from dev.wc_flu_mcradv_2015_vacc b 
    where b.uth_member_id = a.uth_member_id
 ;

select count(*), sum(vacc_flag), data_source, count(distinct uth_member_id) as mem
from dev.wc_flu_mcradv_2015 
...
---all
	r_num := 0;
	r_den := (	select count(*) from dev.wc_flu_mcradv_2015  );
...
---female 
	r_num := 0;
	r_den := (	select count(*) from dev.wc_flu_mcradv_2015  where gender_cd = 'F' );
...
---male 
	r_num := 0;
	r_den := (	select count(*) from dev.wc_flu_mcradv_2015  where gender_cd = 'M' );
...
;
 ...
 select * from dev.wc_flu_mcradv_2015
 
 -- optum by zip 
 --missing zip 753 772 
insert into dev.wc_flu_mcradv_2015 values 
(0001,753,7,'M','optz',0),
(0006,753,7,'F','optz',0),
(0007,772,7,'M','optz',0),
(0012,772,7,'F','optz',0)
