...
-- !!!!!!!!!!!!!!!!
-- NOTE: Issue with a 'F' value found in MHSACOVG and 's' for dstatus in std113.csv and also non-character data.  Leaving that file out for now.
-- !!!!!!!!!!!!!!!
...
insert into truven.std (SEQNUM,ADV_CASE,DTABS1,DTRTW,CASESTAT,DTBEG,DTLAST,ENROLID,CASEID,RTW_FLAG,DAYSABS,CASEDX,PAYTOT,VERSION)
...
insert into truven.std (SEQNUM,ADV_CASE,DTABS1,DTRTW,CASESTAT,DTBEG,DTLAST,EFAMID,ENROLID,CASEID,RTW_FLAG,DAYSABS,CASEDX,PAYTOT,VERSION )
...
insert into truven.std (SEQNUM,ADV_CASE,DTABS1,DTRTW,CASESTAT,DTBEG,DTLAST,EFAMID,ENROLID,CASEID,RTW_FLAG,DAYSABS,CASEDX,DXVER,PAYTOT,VERSION)
