...
drop external table ext_ccaeo_v1;
CREATE EXTERNAL TABLE ext_ccaeo_v1 (
	seqnum numeric,
	version int2,
	dx1 bpchar(10),
	dx2 bpchar(10),
...
truncate table truven.ccaeo;

insert into truven.ccaeo (SEQNUM,VERSION,DX1,DX2,PROC1,PROCTYP,EFAMID,ENROLID,REVCODE,SVCDATE,DOBYR,YEAR,
...
drop external table ext_ccaeo_v2;
CREATE EXTERNAL TABLE ext_ccaeo_v2 (
	seqnum numeric,
	version int2,
	dx1 bpchar(10),
	dx2 bpchar(10),
...
insert into truven.ccaeo (SEQNUM,VERSION,DX1,DX2,DXVER,PROC1,PROCTYP,EFAMID,ENROLID,REVCODE,SVCDATE,DOBYR,YEAR,
