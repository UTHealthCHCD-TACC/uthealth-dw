...
outfile = export_path + 'Elig_07112022.txt'
...
while loop_counter > 0:
    ...
    data = [
              [ '1111111' for i in range(chunksize)] #Data Submitter Code--  varchar 8
            , [ 'PAYER11' for i in range(chunksize)] #Payor Code --  varchar 8
            ...
            , [ randomString(8) for i in range(chunksize)] #Member Date of Birth --  date 8
            ...
            , [ 'ME' for i in range(chunksize)] #Record Type --  char 2
    ]
