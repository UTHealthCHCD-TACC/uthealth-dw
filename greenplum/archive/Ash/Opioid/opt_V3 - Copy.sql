...
--select count(*) as Step_1a_Count from dev.am_opt_opioid_enrolled_2012
--10679879
...
--select count(*) as Step_1_Count from dev.am_opt_opioid_step_1
--1508332
-------------------------------------------------------------------------------------------------------	
...
--select count(*) as Step_2_Count from dev.am_opt_opioid_step_2
--1508332
-------------------------------------------------------------------------------------------------------
