---Influenza Vacc Prevalence 65+ for 2018---

---external file from sql server for medicaid
drop table dev.wc_temp_mdcd65_flu_2018

create table dev.wc_temp_mdcd65_flu_2018 ( client_num text, fst_elig text, lst_elig text, zip3 char(3), sex char(1), age text, age_group text, vacc_flag text);

update dev.wc_temp_mdcd65_flu_2018 set vacc_flag = '0' where vacc_flag = '';

select count(*) , sum (vacc_flag::int) from dev.wc_temp_mdcd65_flu_2018


---dw sources
drop table dev.wc_flu_65plus_2018;
...
---medicare advantage
insert  into dev.wc_flu_65plus_2018
select uth_member_id, 
       a.gender_cd, 
       a.zip3,
...
----get vacc rates
drop table dev.wc_flu_65plus_2018_vacc;

select distinct uth_member_id 
into dev.wc_flu_65plus_2018_vacc
...
where a.cpt_hcpcs in ('90630','90654','90655','90655','90656','90657','90658','90658','90660','90661','90662',
      ...
      and a.year = 2018 
      and a.uth_member_id in ( select uth_member_id from dev.wc_flu_65plus_2018)
;


alter table dev.wc_flu_65plus_2018 add column vacc_flag int2 default 0;


update dev.wc_flu_65plus_2018 a set vacc_flag = 1
  from dev.wc_flu_65plus_2018_vacc b 
    where b.uth_member_id = a.uth_member_id
 ;


drop table dev.wc_flu_65plus_all_2018;

--merge w/medicaid
select * 
into dev.wc_flu_65plus_all_2018
from ( 
select * from dev.wc_flu_65plus_2018
union 
select client_num::bigint, sex, zip3, 'mdcd' as data_source,  vacc_flag::int from dev.wc_temp_mdcd65_flu_2018
) inr 
...
from dev.wc_flu_65plus_all_2018 a 
...
insert into dev.wc_flu_65plus_all_2018 values ('1','M','750','optz','0'),
('2','M','751','optz','0'),
('3','M','752','optz','0'),
('4','M','753','optz','0'),
('5','M','754','optz','0'),
