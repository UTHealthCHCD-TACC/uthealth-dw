---influenza vacc prevelance 2018 medicare 

---optum and truven cohorts from DW
drop table dev.wc_flu_mdcr_2018;
...
drop table dev.wc_flu_mdcr_2018_vacc;

select distinct uth_member_id 
into dev.wc_flu_mdcr_2018_vacc
...
where a.cpt_hcpcs in ('90630','90654','90655','90655','90656','90657','90658','90658','90660','90661','90662',
      ...
      and a.year = 2018 
      and a.uth_member_id in ( select uth_member_id from dev.wc_flu_mdcr_2018)
;


alter table dev.wc_flu_mdcr_2018 add column vacc_flag int2 default 0;


update dev.wc_flu_mdcr_2018 a set vacc_flag = 1
  from dev.wc_flu_mdcr_2018_vacc b 
    where b.uth_member_id = a.uth_member_id
 ;

select count(*), sum(vacc_flag), data_source, count(distinct uth_member_id) as mem
from dev.wc_flu_mdcr_2018 
