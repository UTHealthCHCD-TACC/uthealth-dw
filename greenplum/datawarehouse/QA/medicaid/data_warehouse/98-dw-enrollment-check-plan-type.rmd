...
and compares them to the data_warehouse yearly enrollment table
...
from dev.xz_dwqa_temp1 b
	left join data_warehouse.member_enrollment_yearly_1_prt_mdcd a
...
a.zip5, a.plan_type
from data_warehouse.member_enrollment_monthly_1_prt_mdcd a left join b
...
if (nrow(sex_mismatches) > 0){
  for (i in 1:min(nrow(sex_mismatches), records_to_print)){
    ...
    writeData(wb, sheet = 2, "Mismatch details from TACC data_warehouse monthly table",
  ...
  writeData(wb, sheet = 2, "No sex mismatches", startCol = 1, startRow = next_row)
}
...
if (nrow(race_mismatches) > 0){
  for (i in 1:min(nrow(race_mismatches), records_to_print)){
    ...
    writeData(wb, sheet = 3, "Mismatch details from TACC data_warehouse monthly table",
              startCol = 1, startRow = next_row)
  ...
  writeData(wb, sheet = 2, "No race mismatches", startCol = 1, startRow = next_row)
}
...
if (nrow(zip_mismatches) > 0){
  for (i in 1:min(nrow(zip_mismatches), records_to_print)){
    ...
    writeData(wb, sheet = 4, "Mismatch details from TACC data_warehouse monthly table",
              startCol = 1, startRow = next_row)
  ...
  writeData(wb, sheet = 2, "No zip mismatches", startCol = 1, startRow = next_row)
}
...
if (nrow(plan_mismatches) > 0){
  for (i in 1:min(nrow(plan_mismatches), records_to_print)){
    ...
    writeData(wb, sheet = 5, "Mismatch details from TACC data_warehouse monthly table",
              startCol = 1, startRow = next_row)
  ...
  writeData(wb, sheet = 2, "No plan mismatches", startCol = 1, startRow = next_row)
}
