...
select top @rows_to_check a.hdr_frm_dos as from_dos,
	...
	a.icn as icn,
	case when a.hdr_txm_cd  = '' then null else a.hdr_txm_cd end as provider_type
...
spc_sql2 = "insert into CHCDWORK.dbo.xz_dwqa_temp1
  select top @rows_to_check FRM_DOS,
	...
	DERV_ENC as icn,
	case when BILL_PROV_TAX_CD = '' then null else BILL_PROV_TAX_CD end as provider_type
...
select a.*, b.from_date_of_service, b.claim_type as dw_claim_type, b.total_charge_amount, b.total_allowed_amount,
	...
	case when b.provider_type is null and a.provider_type is null then 0 when b.provider_type is null then 1 when b.provider_type::text != trim(a.provider_type)::text then 1 else 0 end as provider_type_mismatch
