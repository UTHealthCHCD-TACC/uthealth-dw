...
here::i_am("21-dw-rx-counting-pt2.rmd")
```
...
# SECTION 2: Count distinct rx_ids from dw_staging schema on TACC
...
from dw_staging.mcd_pharmacy_claims
...
writeData(wb, sheet = 1, "Count of distinct PCN || NDC || FILL_DT combinations between SPC server and dw_staging", startCol=1, startRow=1)
