...
# PURPOSE
This R markdown script spot checks for matching details information in data_warehouse
...
case when b.provider_npi is null and trim(a.spc_provider_npi) = '' then 0 
  when b.provider_npi is null and a.spc_provider_npi is not null then 1 
  when b.provider_npi::text != a.spc_provider_npi then 1 else 0 end as provider_npi_mismatch,
