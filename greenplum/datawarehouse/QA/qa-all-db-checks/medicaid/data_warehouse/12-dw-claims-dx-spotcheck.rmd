...
#Purpose:
This R markdown script spot checks for the existence of dx and proc codes in data_warehouse
...
## 3.3 Convert empty ICD codes to null so they don't throw mismatches
```{sql, connection = tac}
...
select a.*, b.claim_id_src, b.fiscal_year, b.member_id_src, b.from_date_of_service, b.icd_version, b.diag_cd,
	...
	case when b.icd_version is null and a.icd is not null then 1
...
from dev.xz_dwqa_temp2 a left join data_warehouse.claim_diag_1_prt_mdcd b on a.icn = b.claim_id_src and a.dx = b.diag_cd;
...
select a.fy, count(*)
from dev.xz_dwqa_temp1 a left join data_warehouse.claim_diag_1_prt_mdcd b on a.icn = b.claim_id_src
...
writeData(wb, sheet = 1, "Mismatches found in claim_diag tables between SPC and data_warehouse", startCol=1, startRow=1)
