...
***MODIFIED FOR DATA WAREHOUSE***

It selects random rows from the data_warehouse yearly enrollment table and compares
...
from data_warehouse.member_enrollment_yearly_1_prt_mdcd a left join b
