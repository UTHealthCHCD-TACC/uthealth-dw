...
## 2.1 First make sure rx ICN and encounters DERV_ENC are distinct from each other
...
## 2.2 Count rx and encounters for each 
...
for (yr in starting_yr:ending_yr){
  ...
  if (yr == 12) { #if year = 2012 then count rx only
...
writeData(wb, sheet = 1, "Count of distinct rx in SPCDEDPWPVS1", startCol=1, startRow=1)
