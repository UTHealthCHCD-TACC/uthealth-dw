...
# SECTION 3: Count distinct enrolid-msclmid combinations
...
path = here("outputs", "truven-claims-counting.xlsx")
...
# Declare base SQL queries for modification

truv_sql2 = "select year, '@table'::text as table_src, enrolid::text || msclmid::text as concat
...
# Create enrolid-msclmid combinations for raw Truven tables
for (i in 1:4){
  ...
  if (i == 1) {
   ...
   truv_concat_counts = rbind(truv_counts, current_results)
  }
...
addWorksheet(wb, sheetName="counts")

current_sheet = 1; current_df = truv_concat_counts
