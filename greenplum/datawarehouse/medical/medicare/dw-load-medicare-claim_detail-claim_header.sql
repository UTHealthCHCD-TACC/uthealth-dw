...
select 'mdcr', c.uth_claim_id, b.uth_member_id, a.clm_from_dt::date, a.nch_clm_type_cd, a.clm_fac_type_cd, NULL, NULL, 
...
where extract(year from clm_from_dt::date) between 2015 and 2017
;
...
insert into dw_qa.claim_header (data_source, uth_claim_id, uth_member_id, from_date_of_service, claim_type, place_of_service, uth_admission_id, admission_id_src,
						        total_charge_amount, total_allowed_amount, total_paid_amount, claim_id_src, member_id_src, table_id_src)  
select  'mdcr', c.uth_claim_id, b.uth_member_id, a.clm_from_dt::date, a.nch_clm_type_cd, null, null, null, 
