...
delete from data_warehouse.claim_diag where data_source = 'mcrt' and data_year is null;
...
delete from data_warehouse.claim_diag where data_source = 'mcrt' and diag_cd is null;
