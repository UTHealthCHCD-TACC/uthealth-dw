 ...
 * INITIALIZE TABLE
 ****************************/
drop table if exists dw_staging.mcrt_member_enrollment_yearly;

create table dw_staging.mcrt_member_enrollment_yearly 
 ...
 ********************************/
insert into dw_staging.mcrt_member_enrollment_yearly (
         data_source, 
         year, 
         uth_member_id, 
		 age_derived, 
...
--Add month flags
	...
	loop
	execute
	'update dw_staging.mcrt_member_enrollment_yearly y
...
update dw_staging.mcrt_member_enrollment_yearly
set total_enrolled_months = enrolled_jan + enrolled_feb + enrolled_mar + 
	enrolled_apr + enrolled_may + enrolled_jun + enrolled_jul + enrolled_aug + 
	enrolled_sep + enrolled_oct + enrolled_nov + enrolled_dec;

vacuum analyze dw_staging.mcrt_member_enrollment_yearly;
...
update dw_staging.mcrt_member_enrollment_yearly a set gender_cd = b.gender_cd 
...
begin
	...
	loop
		...
		execute 'update dw_staging.mcrt_member_enrollment_yearly a
