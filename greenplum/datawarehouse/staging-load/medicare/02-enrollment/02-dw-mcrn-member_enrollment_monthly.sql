...
drop table if exists dw_staging.mcrn_member_enrollment_monthly_etl;

create table dw_staging.mcrn_member_enrollment_monthly_etl (
	year int2,
	bene_id text,
	dob date,
	dod date,
...
begin
	...
	loop
		...
		execute 'insert into dw_staging.mcrn_member_enrollment_monthly_etl
...
--select * from dw_staging.mcrn_member_enrollment_monthly_etl order by year, bene_id limit 10;
