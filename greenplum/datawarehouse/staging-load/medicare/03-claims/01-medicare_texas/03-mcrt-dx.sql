...
vacuum analyze dw_staging.mcrt_diag_etl;
--select * from dw_staging.mcrt_diag_etl;
--select count(*) from dw_staging.mcrt_diag_etl;
--1683751849
...
drop table if exists dw_staging.mcrt_claim_diag;

create table dw_staging.mcrt_claim_diag 
...
insert into dw_staging.mcrt_claim_diag(
...
from dw_staging.mcrt_diag_etl a
...
vacuum analyze dw_staging.mcrt_claim_diag;

--select * from dw_staging.mcrt_claim_diag;
