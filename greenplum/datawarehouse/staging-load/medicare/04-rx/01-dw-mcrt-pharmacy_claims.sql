...
/* ******************************************************************************************************
 *  load pharmacy_claims for Medicare Texas
 * ******************************************************************************************************
 *  Author  || Date       || Notes
 * ******************************************************************************************************
...
drop table if exists dw_staging.mcrt_pharmacy_claims;

create table dw_staging.mcrt_pharmacy_claims 
...
insert into dw_staging.mcrt_pharmacy_claims(
...
left join data_warehouse.dim_uth_rx_claim_id b
    on a.pde_id = b.rx_claim_id_src and b.data_source = 'mcrt';

vacuum analyze dw_staging.mcrt_pharmacy_claims;
