...
--note that many variables in optden are already cleaned such as DOB
insert into dw_staging.optd_member_enrollment_yearly  (
         data_source, 
         year, 
         uth_member_id, 
		 age_derived, 
...
analyze dw_staging.optd_member_enrollment_yearly;
...
--Add month flags
	...
	loop
	execute
	'update dw_staging.optd_member_enrollment_yearly y
...
update dw_staging.optd_member_enrollment_yearly
...
--vacuum analyze
vacuum analyze dw_staging.optd_member_enrollment_yearly;
...
-----------------------------------------------------------------------------------------------------------------------
	...
	loop
		...
		execute 'update dw_staging.optd_member_enrollment_yearly a set ' || col_list[col_counter] ||' = b.' || col_list[col_counter] ||'
