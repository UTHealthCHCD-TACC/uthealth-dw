 ...
 * ******************************************************************************************************
 *  xzhang  || 07/20/2023 || Split into truc and truc, added table_id_src, rewrote dupe row deletion portion
 * 							 so that we are now retaining the highest position number and ccaes table, preferentially
 * 
