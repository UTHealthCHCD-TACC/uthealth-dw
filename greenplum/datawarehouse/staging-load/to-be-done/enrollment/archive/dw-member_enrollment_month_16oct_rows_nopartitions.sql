...
select distinct data_source from data_warehouse.member_enrollment_monthly_16oct_rownoparts
/* As of 02oct2019: mdcr, trvm, trvc, optz, optd */

/* create the partititioned monthly enrollment table */
create table data_warehouse.member_enrollment_monthly_16oct_rownoparts (
    --ID columns
	id bigserial,
	data_source char(4), 
	month_year_id int4,
...
/*  no partitioning in this scenario
...
insert into data_warehouse.member_enrollment_monthly_16oct_rownoparts
select * from data_warehouse.member_enrollment_monthly where data_source <> 'mdcr'

analyze data_warehouse.member_enrollment_monthly_16oct_rownoparts

select count(id) from data_warehouse.member_enrollment_monthly_16oct_rownoparts
...
from data_warehouse.member_enrollment_monthly_16oct_rownoparts
